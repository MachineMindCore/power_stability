...
%Fault cleared
[Yaf]=ybusaf(linedata, yload, nbus1,nbust, nbrt, fline);
fprintf('\nPostfault reduced bus admittance matrix\n')
Yaf
resptc='y';
while resptc =='y' | resptc=='Y'
%tc must be defined. Clearing time of fault
%tf must be defined. Final time of simularion
clear t  x  del
t0 = 0;
...
resptc=resp;
    ...
    resp2='n'; % Modified to not repeat
